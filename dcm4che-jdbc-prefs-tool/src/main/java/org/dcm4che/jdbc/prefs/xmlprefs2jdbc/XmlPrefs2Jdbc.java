 ...
 */
public class XmlPrefs2Jdbc {

    private static ResourceBundle rb = ResourceBundle.getBundle("org.dcm4che.jdbc.prefs.xmlprefs2jdbc.messages");

    public static void main(String[] args) {
        System.setProperty("java.util.prefs.PreferencesFactory", "org.dcm4che.jdbc.prefs.PreferencesFactoryJDBCImpl");
        try {
            BufferedInputStream is = new BufferedInputStream(new FileInputStream(fname(args)));
            try {
            ...
            System.err.println("xmlprefs2jdbc: " + e.getMessage());
            e.printStackTrace();
            System.exit(2);
        }
    }
    ...
    private static String fname(String[] args) {
        ...
        if (fname.equals("-h") || fname.equals("--help")) {
            ...
            Package p = XmlPrefs2Jdbc.class.getPackage();
            String s = p.getName();
